...
export function DataProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    // Las suscripciones en tiempo real ahora se manejan en useRealtimeNotifications
    // para mostrar notificaciones no intrusivas en lugar de recargas automáticas
  }, [user]);
