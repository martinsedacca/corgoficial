    ...
    <div className="bg-white rounded-lg shadow-lg p-8 max-w-4xl mx-auto">
      ...
      <div className="grid grid-cols-2 gap-6 mb-6">
        ...
        <div className="space-y-1 text-right">
          ...
          <div className="text-lg font-semibold">{new Date(prescription.date).toLocaleDateString('es-AR')}</div>
        </div>
      </div>
        ...
        <div className="bg-gray-50 p-4 rounded-lg">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <span className="font-medium">{prescription.patient.socialWork}</span>
            </div>
          </div>
          <div className="mt-2">
      ...
      <div className="mb-8">
        ...
        <div className="text-lg font-semibold">{prescription.doctor.name}</div>
      ...
      <div className="mt-6 text-center">
        <button
          ...
          className="flex items-center gap-2 bg-green-600 text-white px-8 py-3 rounded-lg font-medium hover:bg-green-700 transition-colors mx-auto"
        >
