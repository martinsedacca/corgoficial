-- This migration fixes a column name typo in the RPC function.
-- It changes 'p.lastName' to 'p.last_name' to correctly fetch the patient's name.
...
BEGIN
    ...
    -- ** FIX: Use 'last_name' instead of 'lastName' **
